...
function validateForm() {
    var x = document.forms["feedbackForm"]["inputEmail"].value;
    var atpos = x.indexOf("@");
    var dotpos = x.lastIndexOf(".");
    if (atpos<1 || dotpos<atpos+2 || dotpos+2>=x.length) {
    	document.feedbackForm.inputEmail.focus() ;
...
<div class="container-fluid">
	<div class="row">
		<form class="form-horizontal" name="feedbackForm" action="formsubmit.html" onsubmit="validateForm()" method="post">
